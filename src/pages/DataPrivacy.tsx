      ...
      <AuthContentContainer ableBoxShadow={true}>
        <div className={styles.textContainer}>
          ...
          <div className={styles.contentHolder}>
            ...
            <p>
              For company representatives who registered to the platform, this
              is to inform you that your account will be automatically be
              disabled after 12 months but an email will automatically inform
              you 1 month before the expiration of your account. You can email
              the TPC (Technology Program Coordinator) to communicate regarding
              your account validity.
            </p>
            <h2>Token Expiration</h2>
            <p>
              The token will be expired automatically once it wasn't validated
              in 24 hours.
            </p>
