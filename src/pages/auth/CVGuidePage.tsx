          ...
          <h1 className={styles.title}>Curriculum Vitae Guide</h1>
            ...
            <a>Power Statement / Career Obejctive (no heading)</a>
                <div className={styles.subitems}>
                    ...
                    <a>• characteristic + position desired + what you can contribute to the  company</a>
                    <a>• dynamic, honest, committed Thomasian seeking a position in  your company</a>
                </div>
            </div>
            ...
            <a>Use words such as, excellent, above-average, proficient,  knowledgeable</a>
